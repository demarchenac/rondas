...
export const es: typeof en = {
  ...
  settings_syncContacts: 'Sincronizar fotos de contactos',
  settings_syncContactsInfo: 'Actualiza nombres y fotos de contactos desde tu dispositivo al abrir la app',
