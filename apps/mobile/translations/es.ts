...
export const es: typeof en = {
  ...
  settings_impoconsumoIncludedInfo: 'Cuando está activo, los precios de comida ya incluyen el 8% de impuesto al consumo',
  settings_ivaIncluded: 'IVA (19%)',
  settings_ivaIncludedInfo: 'Cuando está activo, los precios de comercio/servicio ya incluyen el 19% de impuesto al valor agregado',
